...
BOT_TOKEN = getenv("BOT_TOKEN", "5355659500:AAHddqfL_ydc5xd3Xk_z6ZdTcpcxIQu86Qg")
...
BOT_USERNAME = getenv("BOT_USERNAME", "spotibbot")
OWNER_ID = getenv("OWNER_ID", "5494083050")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "SPOTIFY")
GROUP_SUPPORT = getenv("GROUP_SUPPORT", " QOiO1")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", " QOiO1")
